...
<div class="card">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group"><label for="nf-email" class=" form-control-label">Total KM</label><input type="text" name="km" placeholder="Enter Year.." class="form-control" value="<?=(isset($this->loadData['msg']['km']))? $this->loadData['msg']['km']:''?>"></div>
