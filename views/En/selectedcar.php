...
<div>
    <h1 class="text-left"><?=$row['name']?></h1>
    <h2 class="text-left">EGP <?=$row['price']?></h2>
</div>
</section>

<section id="selectedcar-sec2" class="pt-3">
...
<ul class="uk-slideshow-items">
    ...
    <a style="color: #0f6ecd;" class="uk-position-center-right uk-position-small uk-hidden-hover" href="#" uk-slidenav-next uk-slideshow-item="next"></a>
    <a style="color: #0f6ecd;" class="uk-position-center-left uk-position-small uk-hidden-hover" href="#" uk-slidenav-previous uk-slideshow-item="previous"></a>    
...
<div class="uk-position-small">
    ...
    <div class="row m-auto">
        ...
        <?php if(isset($row['km'])){
            ...
            <div>
                <div class="text-center uk-box-shadow-small uk-padding"><?=$row['km']?> Kilometres</div>
            </div>
        </div>
            <?php
        }?>
...
<section id="selectedcar-sec3" class="p-5">
  ...
  <tbody>
      <?php 
      $specifications = explode("/",$row['specifications_en']);
