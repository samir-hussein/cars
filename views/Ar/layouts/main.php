...
<body style="direction: rtl;text-align: right;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="/"><img src="assets/images/logo.webp" alt="logo" width="65"></a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>

            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="p-0 navbar-nav ml-auto">
                    <li class="nav-item mx-xl-4 font-weight-bold">
                        <a class="d-flex nav-link align-self-end" href="/">الرئيسية</a>
                    </li>
                    <li class="nav-item mx-xl-4 font-weight-bold">
                        <a class="nav-link" href="/brands?type=new_brands">سيارات جديدة</a>
                    </li>
                    <li class="nav-item mx-xl-4 font-weight-bold">
                        <a class="nav-link" href="/brands?type=used_brands">سيارات مستعملة</a>
                    </li>
                    <li class="nav-item mx-xl-4 font-weight-bold">
    ...
    <main>
        {{content}}
        <section style="direction: ltr;" class="py-4" id="home-sec7">
        ...
        <div class="row p-md-5 p-3">
            <div class="col-12 col-md-6 col-lg-3">
                <ul class="d-inline-block p-0 m-0 list-unstyled">
                    <li class="my-3"><a href="/" class="text-decoration-none"><span uk-icon="triangle-left"></span>الرئيسية</a></li>
                    <li class="my-3"><a href="javascript:;" onclick="scrl('home-sec3');" class="text-decoration-none"><span uk-icon="triangle-left"></span>عن الشركة</a></li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <ul class="d-inline-block p-0 m-0 list-unstyled">
                <li class="my-3"><a href="/brands?type=new_brands" class="text-decoration-none"><span uk-icon="triangle-left"></span>سيارات جديدة</a></li>
                <li class="my-3"><a href="/brands?type=used_brands" class="text-decoration-none"><span uk-icon="triangle-left"></span>سيارات مستعملة</a></li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <ul class="d-inline-block p-0 m-0 list-unstyled">
                <li class="my-3"><a href="/branches" class="text-decoration-none"><span uk-icon="triangle-left"></span>فروعنا</a></li>
                    <li class="my-3"><a href="/contact-us" class="text-decoration-none"><span uk-icon="triangle-left"></span>تواصل معنا</a></li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <ul class="d-inline-block p-0 m-0 list-unstyled">
